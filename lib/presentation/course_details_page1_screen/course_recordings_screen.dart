...
class _CourseRecordingsScreenState extends State<CourseRecordingsScreen>
  ...
  getData() async {
    await courseContentController
        ...
        .then((v) {
      if (courseContentController.recordings.isNotEmpty) {
        _videoUrl =
            '${HttpUrls.imgBaseUrl}${courseContentController.recordings[0].recordClassLink}';
      }
                        ...
                        return courseContentController.recordings.isNotEmpty
                            ? Column(
                                children: [
                                  ...
                                  SizedBox(height: 16),
                                  ListView.builder(
                                    itemCount: courseContentController
                                        .recordings.length,
                                    shrinkWrap: true,
